---
description: Issue Planning and Automation prompt that generates comprehensive project plans with an Epic to Feature to Story or Enabler to Test hierarchy, dependencies, priorities, and automated tracking.
metadata:
