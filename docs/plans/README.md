...
- `docs/plans/phase-9-rules-main-page-release-ops.md`: active next-version plan for rules main-page release-operations UX, poster presentation, and Jackett run orchestration

`ROADMAP.md` remains the high-level product roadmap. The files in `docs/plans/` are the detailed source of truth for work that is actively being implemented or prepared, with phases 5, 6, 7, and 8 implemented and phase 9 now active for the next-version rules main-page release-operations slice.
