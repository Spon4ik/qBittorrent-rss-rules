...
def _ensure_rule_columns() -> None:
    ...
    expected_settings_columns = {
        ...
        "real_debrid_enabled": "BOOLEAN NOT NULL DEFAULT 0",
        "real_debrid_client_id_encrypted": "TEXT",
        "real_debrid_client_secret_encrypted": "TEXT",
        "real_debrid_access_token_encrypted": "TEXT",
        "real_debrid_refresh_token_encrypted": "TEXT",
        "real_debrid_token_expires_at": "DATETIME",
        "real_debrid_account_username": "VARCHAR(255)",
        "real_debrid_account_premium_until": "DATETIME",
        "real_debrid_connection_status": "VARCHAR(32) NOT NULL DEFAULT 'disconnected'",
        "real_debrid_connection_message": "TEXT NOT NULL DEFAULT ''",
        "real_debrid_webseed_base_url": "VARCHAR(512) NOT NULL DEFAULT 'http://127.0.0.1:8000'",
        "real_debrid_metadata_wait_seconds": "INTEGER NOT NULL DEFAULT 120",
        "myjd_enabled": "BOOLEAN NOT NULL DEFAULT 0",
        "myjd_email": "VARCHAR(255)",
        "myjd_password_encrypted": "TEXT",
        "myjd_device_id": "VARCHAR(255)",
        "myjd_device_name": "VARCHAR(255)",
        "myjd_connection_status": "VARCHAR(32) NOT NULL DEFAULT 'disconnected'",
        "myjd_connection_message": "TEXT NOT NULL DEFAULT ''",
